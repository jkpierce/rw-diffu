...
\begin{figure}[h]
	...
	\caption{Scaling behavior of variance. Left panel shows pure initial conditions while the action-packed right panel shows mixed initial conditions. Mixed initial conditions leads to an emergence of a $\sigma_x^2 \propto t^2$ term. }
	\label{fig:lisledif}
\end{figure}
